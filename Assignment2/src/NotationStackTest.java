...
public class NotationStackTest {
	...
	public double a1 = 1, a2 = 2, a3 = 3, a4 = 4, a5 = 5, a6 = 6;
	...
	public void testPopStudent() {
		try {
			assertTrue(a3 == doubleS.pop().doubleValue());
			assertTrue(a2 == doubleS.pop().doubleValue());
			assertTrue(a1 == doubleS.pop().doubleValue());
			// Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		} catch (StackUnderflowException e) {
	...
	public void testPushStudent() {
		try {
			...
			assertEquals(true, doubleS.push(a4));
			assertEquals(4, doubleS.size());
			assertEquals(true, doubleS.push(a5));
	...
	@Test
	public void testToStringStudent() throws NumberFormatException, StackOverflowException {
